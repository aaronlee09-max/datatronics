const CATEGORY_ICONS = Object.assign({
  "전체":"✦","독립운동":"🇰🇷","나눔폰트":"🌱","1984대화나눔":"💬","학교안심":"🏫","배달의민족":"🍽️","카페24":"☕","KCC":"🎨","G마켓":"🛒","Spoqa":"◉","Tmoney":"🚇","Microsoft":"▦","한국 기본·본문":"📖","고딕·산세리프":"▥","명조·세리프":"📜","손글씨·캘리그래피":"✍️","귀여운·캐주얼":"🐣","제목·디스플레이":"🔠","서울":"🏙️","경기·고양":"🏙️","경남·고성":"🌊","광주":"🌆","전북·완주":"🌿","전북·전주":"🏯","강원·원주":"⛰️","충북·대학":"🎓","경북·영양":"🥬","전남·지역특화":"🌾","문화재·전통":"🏛️","공공·환경":"🏛️","브랜드·기업":"🏢","안성탕면":"🍜","프리젠테이션":"🎤","함렛":"📚","페이퍼로지":"📄","KOTRA":"🌐","온글잎":"🖋️","KERIS":"🎓","김정철":"🖌️","KoPubWorld":"📘","KOTRA":"🌐","순수바탕":"📰","표진고딕":"▥","상주":"🏞️","칠곡":"🌳","고신고딕":"⛪","코딩폰트":"💻","코딩·개발":"⌨️","영문·라틴":"🔤","모노스페이스":"▤","픽셀·레트로":"👾","기호·딩벳":"🔣"
};, {
  "나눔바른고딕": "🌱",
  "나눔고딕": "🌱",
  "나눔명조": "🌱",
  ...
  "KCC 무럭무럭": "🎨",
  "KCC 손기정": "🎨"
},"영문·세리프":"🔤","영문·산세리프":"🔤","영문·스크립트":"✍️","영문·디스플레이":"✨","영문·모노스페이스":"⌨️","영문·한글/지역":"🌏","영문·기타":"🔠");
const CATEGORIES = [
  "전체","독립운동","나눔폰트","1984대화나눔","학교안심","배달의민족","카페24","KCC","G마켓","Spoqa","Tmoney","Microsoft",
  "한국 기본·본문","고딕·산세리프","명조·세리프","손글씨·캘리그래피","귀여운·캐주얼","제목·디스플레이",
  "서울","경기·고양","경남·고성","광주","전북·완주","전북·전주","강원·원주","충북·대학","경북·영양","전남·지역특화","문화재·전통","공공·환경",
  "브랜드·기업","안성탕면","프리젠테이션","함렛","페이퍼로지","KOTRA","온글잎","KERIS","김정철","KoPubWorld","순수바탕","표진고딕","상주","칠곡","고신고딕",
  "코딩폰트","코딩·개발","영문·라틴","모노스페이스","픽셀·레트로","기호·딩벳"
  "영문·세리프",
  "영문·산세리프",
  "영문·스크립트",
  "영문·디스플레이",
